...
reviews_3 = FactoryBot.create_list(:random_shelter_review, 3, shelter: shelter_1)
reviews_3 = FactoryBot.create_list(:random_shelter_review, 3, shelter: shelter_2)
reviews_3 = FactoryBot.create_list(:random_shelter_review, 3, shelter: shelter_3)
